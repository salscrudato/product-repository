    ...
    <Container>
      ...
      <FieldGroup>
        <LabelRow>
          ...
          <AIBadge><SparklesSolid /><span>Smart Suggestions</span></AIBadge>
        </LabelRow>

        <InputWrapper $isFocused={isFocused} $hasError={!!duplicateMatch}>
          ...
          />
          {value && (
            <ClearButton onClick={() => onChange('')}><XMarkIcon /></ClearButton>
          )}
        </InputWrapper>
      ...
      <FieldGroup $isSecondary>
        <LabelRow>
          ...
          {isAutoCodeEnabled && !hasUserEditedCode && value && (
            <AutoBadge><CheckCircleIcon />Auto-generated</AutoBadge>
          )}
        </LabelRow>
        <CodeInputWrapper $isAutoGenerated={isAutoCodeEnabled && !hasUserEditedCode && !!value}>
          <CodeInput
            type="text"
            value={coverageCode}
        ...
        <HelpText>Unique identifier for this coverage (auto-generated from name)</HelpText>
      </FieldGroup>
    </Container>
  );
};
